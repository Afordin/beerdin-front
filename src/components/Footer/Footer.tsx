...
const Footer = () => {
  ...
  return (
    <footer className="w-full pt-5 pb-10 px-16 bg-white border-t border-cs-slate-300 grid grid-rows-auto text-text-primary space-y-4 m-0">
            ...
            <div className="group flex justify-center items-center -space-x-3 hover:space-x-0 w-full h-full flex-wrap">
              {!isLoading ? (
                designers.map((designer) => (
                  ...
                  >
                    <img src={designer.avatar_url} alt={designer.login} className="w-11 h-11 rounded-full shadow-inner" />
                  </a>
                ))
              ) : (
                <>
              ...
              {!isLoading ? (
                contributors.map((contributor) => (
                  <a
                    ...
                    className="transition-all duration-500 ease-in-out transform hover:scale-150 hover:z-10"
                  >
                    <img src={contributor.avatar_url} alt={contributor.login} className="w-11 h-11 rounded-full shadow-inner" />
                  </a>
                ))
              ) : (
                <>
      ...
      <div className="w-full flex justify-between items-center h-fit">
        <div className="flex justify-center items-center space-x-6">
          ...
          <svg width="44" height="48" viewBox="0 0 196 256" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <div className="flex flex-col text-left">
            ...
            <p className="text-sm text-[#60646C]">The best programming community in the world</p>
          </div>
        </div>
        <div className="flex justify-center items-center space-x-6">
          <div className="group social-icon">
            <a href="https://discord.com/invite/comuafor" className="social-icon-link">
              {/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 20" className="social-icon-svg">
                <path
          ...
          <div className="group social-icon">
            <a href="https://github.com/Afordin" aria-label="Github link" className="social-icon-link">
              {/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 18 20" className="social-icon-svg">
                <path
